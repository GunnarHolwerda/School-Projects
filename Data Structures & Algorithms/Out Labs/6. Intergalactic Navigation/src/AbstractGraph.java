...
public abstract class AbstractGraph implements Graph {
    ...
    public void loadEdgesFromArray(ArrayList<Edge> edgeArray){
        for (int i = 0; i < edgeArray.size(); i++){
            insert(edgeArray.get(i));
        }
    }
     ...
     *                                  nor "List"
     */
    public static Graph createGraph(ArrayList<Location> locations,
            boolean isDirected,
            String type,
        ...
        returnValue.loadEdgesFromArray(edgeArray);
        return returnValue;
    }
}
/*</listing>*/
