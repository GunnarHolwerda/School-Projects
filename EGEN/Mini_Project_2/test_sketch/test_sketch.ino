...
int gateServoPin = 9, stirringServoPin = 10;          //Pin of servo motors
int solenoidTime = 500;                              // How long to open the solenoid valve for
int stirSwipes = 15;                                 //how many times the stirrer swipes
...
void stir() {
  for(int pos = 60; pos <= 97; pos += 1) // goes from 60 degrees to 97 degrees 
  {                                  // in steps of 1 degree 
    stirringServo.write(pos);        // tell servo to go to position in variable 'pos' 
    delay(10);                       // waits 15ms for the servo to reach the position 
  } 
  for(int pos = 97; pos >= 60; pos -= 1) // goes from 97 degrees to 60 degrees 
  {                                
